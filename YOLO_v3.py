...
train_dataset = YOLODataset(
    image_dir='E:\AI project\data\faces\train\images',
    label_dir='E:\AI project\data\faces\train\labels',
    anchors=ANCHORS,
...
test_dataset = YOLODataset(
    image_dir='E:\AI project\data\faces\val\images',
    label_dir='E:\AI project\data\faces\val\labels',
    anchors=ANCHORS,
    image_size=image_size,
